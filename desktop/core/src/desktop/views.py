...
def commonheader_m(title, section, user, padding="90px", skip_topbar=False, skip_idle_timeout=False):
  return commonheader(title, section, user, padding, skip_topbar, skip_idle_timeout, True)

def commonheader(title, section, user, padding="90px", skip_topbar=False, skip_idle_timeout=False, is_mobile=False):
  """
